...
func (c *userService) CreateUser(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *userHandler) CreateUser(ctx context.Context, in *Request, out *Response) error {
